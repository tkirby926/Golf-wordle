...
export class SearchBarComponent extends React.Component {
    ...
    render() {
     ...
     crossorigin="anonymous"></script>
                ...
                <button class={this.state.cant_guess ? "big_form_gray" : "big_form_green"} onClick={(e) => this.showHintConfirmation(e)} hidden={this.state.hint_requested} disabled={this.state.cant_guess}>
                    <p>Show Hint</p>
                </button>
