    ...
    acceptGuess(e, guessid) {
        ...
        .then((data) => {
            ...
            if (data.no_guesses) {
                ...
                this.setState({autocomp_results: [], num_guesses: num_guess, guesses: x, cant_guess: true, answer: data.guess_data.slice(0, 9), hide_winning_popup: false, hide_dropdown: true, hide_login_popup: true, hide_create_popup: true, hide_rules_popup: true})
    ...
    showFriends() {
        ...
        return (
            <div>
                ...
                <p>Friends:</p>
                <div class="req_header" style={{display: this.state.friends.length == 0 ? 'none' : 'inline-block'}}>
